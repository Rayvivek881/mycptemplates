...
class persistent_tree {
  ...
  Node query(int ind, int l, int r, int start, int end, int version) {
    if (l >= start && r <= end) {
...
public:
  ...
  Node query(int start, int end, int version) {
